...
// ---------- Ensure Mongo indexes in the background ----------
// Never block or crash startup: on serverless hosts (Vercel) a slow or unreachable database
// during boot would otherwise make the whole function fail before it can answer any request.
_ = Task.Run(async () =>
{
    try
    {
